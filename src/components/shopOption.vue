	...
	<div class="shopOption">
		...
		<van-action-sheet v-model="showAdrssShop">
			...
			<div class="shopBu">
				...
				<van-button class='vanCalss' size="small" @click='reduce()' disabled v-else>-</van-button>
		...
		<!--购物车底部定位-->
		<van-goods-action>
			<van-goods-action-icon icon="chat-o" text="客服" color="#ee0a24" badge='1' />
			<van-goods-action-icon icon="cart-o" text="购物车" to='/components/miShop' :badge=badgeShop />
